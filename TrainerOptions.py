...
class TrainerOptions:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--arch_initialization', type=str, default='he_truncated')
        parser.add_argument('--arch_initialization_constant_stddev', type=float, default=0.1)
        ...
        parser.add_argument('--arch_aux_bottleneck_layer_count', type=int, default=4)
        parser.add_argument('--opt_iterations', type=int, default=2000000)
        parser.add_argument('--opt_learning_rate', type=float, default=1e-3)
        parser.add_argument('--opt_min_learning_rate', type=float, default=1e-6)
        parser.add_argument('--opt_learning_rate_decay', type=float, default=0.995)
        parser.add_argument('--opt_momentum', type=float, default=0.0)
        parser.add_argument('--opt_decay', type=float, default=0.9)
        parser.add_argument('--opt_epsilon', type=float, default=1e-8)
        parser.add_argument('--opt_weight_decay', type=float, default=0)#1e-4
        parser.add_argument('--opt_dropout_keep_prob', type=float, default=0.8)
        parser.add_argument('--opt_output_weights', type=str, default='1.0,1.0')
        parser.add_argument('--val_loss_iter_print', type=int, default=20)
        parser.add_argument('--train_loss_iter_print', type=int, default=20)
        ...
        parser.add_argument('--loss_adjustment_factor', type=float, default=1.1)
        ...
        parser.add_argument('--loss_adjustment_max_epochs', type=int, default=2)
