...
def preprocess_image(image, is_training, output_height, output_width,
                     label=None,
                     resize_side_min=_RESIZE_SIDE_MIN,
                     resize_side_max=_RESIZE_SIDE_MAX):
    return tf.cond(is_training,
                   lambda: preprocess_for_train(image, label, output_height, output_width,
                                                resize_side_min, resize_side_max),
                   lambda: preprocess_for_eval(image, label, output_height, output_width,
                                               resize_side_min))
